...
let person1 = new Patients(avatarPath + "patiente_cecile.png", "Cécile Moulin", 81);
let person2 = new Patients(avatarPath + "patiente_ju_clara.png", "Juliette Masselis", 39);
let person3 = new Patients(avatarPath + "patient_rene.png", "René Guitay", 81);
let person4 = new Patients(avatarPath + "patiente_ju_clara.png", "Clara Camalet", 31);
let person5 = new Patients(avatarPath + "patiente_lola.png", "Lola Dufour", 81);
let person6 = new Patients(avatarPath + "patient_etienne.png", "Etienne Morié", 81);
